...
$title = htmlspecialchars($conteudo['titulo']) . " | " . NOME_SISTEMA;
...
.study-mode-button.active-mode {
    background-color: var(--green-main);
    color: white;
    box-shadow: 0 5px 15px rgba(93, 112, 52, 0.3);
}

.study-mode-button.active-mode:hover {
    background-color: var(--green-dark);
    color: white;
}

.study-mode-button.secondary-mode {
    background-color: white;
    color: var(--green-dark);
    border: 2px solid var(--green-main);
}

.study-mode-button.secondary-mode:hover {
...
<main class="content-page">
    ...
    <div class="content-container">
        ...
        <a href="conteudos.php?materia_id=<?= (int) $conteudo['materia_id']; ?>" class="back-link">
        ...
        <!-- =========================================
             STUDY MODE SWITCHER
             (ESCOLHER ENTRE AULA E QUESTÕES)
        ========================================== -->

        <div class="study-mode-switch">

            <a href="conteudo.php?id=<?= (int) $conteudoId; ?>" class="study-mode-button active-mode">
                <i class="fa-solid fa-video"></i>
                Ver aulas
            </a>

            <a href="questoes_conteudo.php?conteudo_id=<?= (int) $conteudoId; ?>" class="study-mode-button secondary-mode">
        ...
        <?php if (!empty($aulas)): ?>
            ...
            <?php foreach ($aulas as $aula): ?>
                ...
                <div class="lesson-card">
                    ...
                    <a href="aula.php?id=<?= (int) $aula['id']; ?>" class="lesson-link">
                        ...
                        <i class="fa-solid fa-arrow-right lesson-arrow"></i>
        ...
        <?php else: ?>
            ...
            <div class="empty-lessons">
                ...
                <p>
                    ...
                    em breve. Enquanto isso, que tal praticar com
                    as questões?
                </p>

                <a href="questoes_conteudo.php?conteudo_id=<?= (int) $conteudoId; ?>" class="questions-button">
