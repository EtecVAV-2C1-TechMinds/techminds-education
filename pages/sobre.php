...
<main id="main-content">
    <header class="hero-sobre py-5 text-center text-white" style="background-color: #839745;">
        <div class="container px-4">
            <h1 class="fw-bold mb-4 fs-2">Sobre a TechMinds Education</h1>
            
            <div class="d-flex justify-content-center">
                <img src="../assets/img/area_externa.png" 
                     alt="Fachada e estrutura externa da TechMinds Education" 
    ...
    <section class="sobre-content py-5 bg-light">
        <div class="container px-4" style="max-width: 750px;">
            ...
            <article class="card border-0 shadow-sm p-4 p-md-5 bg-white rounded-3 position-relative overflow-hidden text-center">
                
                <div class="position-absolute top-50 start-50 translate-middle pointer-events-none" style="z-index: 0; width: 300px; opacity: 0.12;">
                ...
                <div class="position-relative" style="z-index: 1;">
                    ...
                    <p class="text-secondary fs-6 mb-5 leading-relaxed">
